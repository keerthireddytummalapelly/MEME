                        ...
                        <div class="card shadow-2-strong card-registration">
                          <div class="card-body p-4 p-md-5">
                            <%@include file="businessMessage.jsp" %>
                              ...
                              <sf:form method="post" action="${pageContext.request.contextPath}/AddUser"
                                modelAttribute="form">
                                <sf:input type="hidden" id="id" class="form-control form-control-lg" path="id" name="id"
                                  value="${form.id}" />
                                <div class="row">
                                  <div class="col-md-6 mb-4">
                                    <div class="form-outline">
                                      <s:bind path="firstName">
                                        ...
                                        <sf:input type="text" id="firstName" class="form-control form-control-lg"
                                  ...
                                  <div class="col-md-6 mb-4">
                                    ...
                                    <div class="form-outline">
                                      <s:bind path="lastName">
                                        ...
                                        <sf:input type="text" id="lastName" class="form-control form-control-lg"
                                          path="lastName" />
                                        <font color="red" style="font-size: 15px">
                                          <sf:errors path="${status.expression}" />
                                        </font>
                                  ...
                                  <div class="col-md-6 mb-4 d-flex align-items-center">
                                    <s:bind path="dob">
                                      <div class="form-outline datepicker w-100">
                                        ...
                                        <sf:input type="date" class="form-control form-control-lg" id="dob" path="dob"
                                  ...
                                  <div class="col-md-6 mb-4">
                                    ...
                                    <s:bind path="gender">
                                      <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="gender" value="Female" checked
                                          name="gender" />
                                        ...
                                        <s:bind path="email">
                                          <div class="form-outline">
                                            ...
                                            <sf:input type="email" id="emailAddress"
                                              class="form-control form-control-lg" path="email" readonly="true" />
                                            <font color="red" style="font-size: 15px">
                                              <sf:errors path="${status.expression}" />
                                            </font>
                                          </div>
                                  ...
                                  <div class="col-md-6 mb-4 pb-2">
                                    <s:bind path="password">
                                      <div class="form-outline">
                                        ...
                                        <sf:input type="password" id="emailAddress" class="form-control form-control-lg"
                                          path="password" />
                                        <font color="red" style="font-size: 15px">
                                          <sf:errors path="${status.expression}" />
                                        </font>
                                  ...
                                  <div class="col-md-6 mb-4 pb-2">
                                    <s:bind path="phoneNumber">
                                      <div class="form-outline">
                                        ...
                                        <sf:input type="tel" id="phoneNumber" class="form-control form-control-lg"
                                          path="phoneNumber" />
                                        <font color="red" style="font-size: 15px">
                                          <sf:errors path="${status.expression}" />
                                        </font>
